...
5. Size → **width ≈ 13 mm** (height auto-fills to ~14 mm). This is the recommended size, the "open source hardware" wordmark is the limiter; 10 mm is the floor, 12-15 mm is comfy.
